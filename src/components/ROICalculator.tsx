...
import { Sparkles, ArrowRight, Info, Share2, Copy, Check, DollarSign, Clock, HelpCircle, Flame } from 'lucide-react';
    ...
    <div id="roi-calculator" className="w-full">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 bg-white p-6 rounded-xs shadow-sm border-2 border-primary space-y-6">
            ...
            <div className="flex justify-between items-center text-sm">
              <label className="text-gray-600 font-bold uppercase tracking-wider text-[11px] flex items-center gap-1">
                ...
                <span className="group relative cursor-pointer">
                  ...
                  <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 p-2 bg-primary text-white text-xs rounded shadow-lg opacity-0 pointer-events-none group-hover:opacity-100 transition duration-150 z-20 font-sans normal-case tracking-normal">
                    Total new buyers & sellers contacting you monthly.
                  </span>
                </span>
              </label>
          ...
          <div className="space-y-2">
            <label className="text-sm text-gray-600 font-bold uppercase tracking-wider text-[11px] block">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center text-sm">
              <label className="text-gray-600 font-bold uppercase tracking-wider text-[11px]">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-3 text-xs font-black uppercase tracking-widest text-primary bg-gray-50 hover:bg-gray-100 border-2 border-primary rounded-xs transition duration-150 active:scale-98 cursor-pointer"
          >
            {shareCopied ? (
              <>
